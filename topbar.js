...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://hxxgkovpsogzfhctapzc.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_64eCmiY1GU8SgeohvZoC2A_SweY8tkl';
...
`;
  ...
  function injectStyleAndHTML() {
    ...
    const style = document.createElement('style'); style.innerHTML += " .topbar-container { display: flex !important; flex-wrap: nowrap !important; overflow-x: auto !important; gap: 8px !important; width: 100% !important; justify-content: space-between !important; padding: 62px 8px 8px 8px !important; background: transparent !important; } .topbar-pill { flex: 1 1 auto !important; background: none !important; border: none !important; box-shadow: none !important; padding: 4px 2px !important; font-size: 10px !important; font-weight: 600 !important; letter-spacing: 0.5px !important; min-width: max-content !important; text-align: center !important; } .topbar-pill::before { margin-right: 3px !important; } "; style.innerHTML += " .topbar-container { display: flex !important; flex-wrap: nowrap !important; overflow-x: auto !important; gap: 4px !important; width: 100% !important; justify-content: space-between !important; padding: 62px 8px 8px 8px !important; } .topbar-pill { flex: 1 1 auto !important; min-width: max-content !important; text-align: center !important; font-size: 11px !important; padding: 6px 8px !important; } @media (max-width: 390px) { .topbar-pill { font-size: 10px !important; padding: 4px 6px !important; } } ";
